...
export default {
  ...
  setup(props) {
    ...
    const getVideoList = () => {
      concentrationApi({}, "get").then((res) => {
        ...
        if (res.code === 0) {
          ...
          console.error("分类列表1", videoList.value);
          if (videoList.value[0]) {
            menuAll(videoList.value[0]);
          }
    ...
    return (_ctx, _cache) => {
      ...
      const _tabs = _resolveComponent("ClassTab");
          ...
          menu_id.value
            ? _createElementVNode("div", _hoisted_35, [
                ...
                _createBlock(
                  ...
                  null,
                  8,
                  ["searchText", "menu_id", "onClose", "jingxuan"]
                )),
              ])
