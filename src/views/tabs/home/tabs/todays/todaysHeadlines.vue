<script>
    import { resolveComponent as _resolveComponent, createVNode as _createVNode, createElementVNode as _createElementVNode, renderList as _renderList, Fragment as _Fragment, openBlock as _openBlock, createElementBlock as _createElementBlock, toDisplayString as _toDisplayString, createCommentVNode as _createCommentVNode, withModifiers as _withModifiers, normalizeStyle as _normalizeStyle, withCtx as _withCtx, createBlock as _createBlock, pushScopeId as _pushScopeId, popScopeId as _popScopeId } from "vue";
...
const _withScopeId = n => (_pushScopeId("data-v-54537e13"), n = n(), _popScopeId(), n);
...
const _hoisted_18 = ["onClick"];
  ...
  return _openBlock(), _createBlock(_component_van_pull_refresh, {
    ...
    default: _withCtx(() => [_createVNode(_component_van_list, {
      ...
      default: _withCtx(() => [_createVNode(_component_SwipeComponent), _createElementVNode("div", _hoisted_1, [_createVNode(_component_advertise_swipe)]), _createElementVNode("div", _hoisted_2, [(_openBlock(true), _createElementBlock(_Fragment, null, _renderList(videoList.value, item => {
        return _openBlock(), _createElementBlock("div", {
          key: item.id,
          class: "video_item",
          onClick: _withModifiers(() => videoPlay(item), ["stop"])
        }, [_createElementVNode("div", _hoisted_4, [_createVNode(_component_my_image, {
          url: item.image
        }, null, 8, ["url"]), _createElementVNode("p", _hoisted_5, _toDisplayString(item.title), 1), _createElementVNode("p", _hoisted_6, [_createElementVNode("span", _hoisted_7, _toDisplayString(item.count) + "次播放", 1), item.times ? (_openBlock(), _createElementBlock("span", _hoisted_8, _toDisplayString(item.times), 1)) : _createCommentVNode("", true)]), _hoisted_9]), _createElementVNode("div", {
          class: "vider_user",
          onClick: _withModifiers(() => toAutorDetails(item), ["stop"])
        }, [_createElementVNode("div", _hoisted_11, [_createVNode(_component_my_image, {
          round: true,
          url: item.top_image
        }, null, 8, ["url"])]), _createElementVNode("div", _hoisted_12, [_createElementVNode("p", _hoisted_13, _toDisplayString(item.nickname), 1), _createElementVNode("p", _hoisted_14, _toDisplayString(item.user_label || "创作者") + "·" + _toDisplayString(item.fans) + "粉丝 ", 1)]), _createElementVNode("div", _hoisted_15, [_createElementVNode("span", {
          onClick: _withModifiers(() => focusSave(item), ["stop"]),
          style: _normalizeStyle({
            color: item.isFocus ? '#999' : '#fd5c18'
          })
        }, _toDisplayString(item.isFocus ? "已关注" : "关注"), 13, _hoisted_16), _createElementVNode("div", null, [_hoisted_17, _createElementVNode("span", null, _toDisplayString(item.comment_num), 1)]), _createElementVNode("img", {
          onClick: _withModifiers($event => showShare(item), ["stop"]),
          src: _imports_2,
          alt: ""
        }, null, 8, _hoisted_18)])], 8, _hoisted_10)], 8, _hoisted_3);
      }), 128))])]),
      _: 1
